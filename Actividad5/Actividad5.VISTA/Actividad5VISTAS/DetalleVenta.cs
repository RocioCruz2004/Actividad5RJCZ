...
namespace Actividad5.VISTA.Actividad5VISTAS
{
    public partial class DetalleVenta : Form
    {
        ...
        {
            VentaSelec fr = new VentaSelec();
            if (fr.ShowDialog() == DialogResult.OK)
            {
                MODELOS.Venta v = bssvent.ObtenerVentaIdBss(IdVentaSeleccionada);
        ...
        {
            ProductoSelec fr = new ProductoSelec();
            if (fr.ShowDialog() == DialogResult.OK)
            {
        ...
        {
            MODELOS.DetalleVenta d = new MODELOS.DetalleVenta();
        ...
        {
            int IdDetalleVentaSeleccionada = Convert.ToInt32(dataGridView1.CurrentRow.Cells[0].Value);
            MODELOS.DetalleVenta editarDetalleVenta = bss.ObtenerDetalleVentaIdBss(IdDetalleVentaSeleccionada);
